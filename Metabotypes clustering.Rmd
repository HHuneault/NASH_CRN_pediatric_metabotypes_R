...
```{r}
# Assuming metabotypes and Study_ID are already loaded into your R environment
...
#### FINAL WITH CHI SQUARE OR FISHERS AS APPROPRIATE 
...
my_colors <- c("1" = "forestgreen", "2" = "orange", "3" = "royalblue1")
